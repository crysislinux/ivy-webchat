...
class Message():
    ...
    CMD_ADD_GPS = 7
    CMD_DELETE_GPS = 8
    CMD_UPDATE_ACCOUNT = 9
    CMD_QUERY_ACCOUNT = 10
    CMD_ADD_ACCOUNT = 11
    CMD_DELETE_ACCOUNT = 12
    ...
    CMD_DELETE_ACCOUNT_OK = 1028
    CMD_ACCOUNT_DELETED = 1029
    CMD_ACCOUNT_UPDATED = 1030
    CMD_ACCOUNT_ADDED = 1031
    CMD_ADD_ACCOUNT_OK = 1032
    CMD_UPDATE_ACCOUNT_OK = 1033
    CMD_QUERY_ACCOUNT_OK = 1034
